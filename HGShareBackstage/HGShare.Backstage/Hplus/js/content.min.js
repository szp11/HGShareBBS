...
if ($(".tooltip-demo").tooltip({
    ...
    var gohome = '<div class="gohome"><a class="animated bounceInUp" href="/Home/Main/" title="返回首页"><i class="fa fa-home"></i></a></div>';
    $("body").append(gohome)
}
/*刷新当前页*/
function TabPageReload() {
