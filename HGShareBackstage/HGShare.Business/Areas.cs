...
namespace HGShare.Business
{
    ...
    public class Areas
    {
        ...
        /// <returns></returns>
        public static AreaVModel AreaInfoToVModel(AreaInfo areaInfo)
        {
            if (areaInfo == null)
            ...
            return new AreaVModel
            {
                ...
                SortPinYin = areaInfo.SortPinYin,
                Sort = areaInfo.Sort,
        ...
        /// </summary>
        /// <param name="areaVModel"></param>
        /// <returns></returns>
        public static AreaInfo AreaVModelToInfo(AreaVModel areaVModel)
        {
            if (areaVModel == null)
                return new AreaInfo();
            return new AreaInfo
            {
                Id = areaVModel.Id,
                Name = areaVModel.Name,
                Code = areaVModel.Code,
                PinYin = areaVModel.PinYin,
                SortPinYin = areaVModel.SortPinYin,
                Sort = areaVModel.Sort,
                ParentCode = areaVModel.ParentCode
            };
        }
        /// <summary>
